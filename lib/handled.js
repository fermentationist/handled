const handledModule = (() => {
	...
	console.error = input => {
		// log input to console, in red
		console.log("\x1b[35m", `Error handled: ${input}`);
		// reset console to standard colors
		console.log("\x1b[0m");
	}
	...
	const assignCallback = callbackFn => {
		...
		return console.error("handled.js error: \"assignDefaultCallback\" failed – argument must be a function")
	}
